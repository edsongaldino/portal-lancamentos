                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                          ...
                          <tr>
                            <td height="20" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="5" align="left" class="inner" id="banner4" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                              ...
                              ';
                              if($oferta["id_tipo"] == 3 || $oferta["id_tipo"] == 4):
                              $template_email.='
                              <tr>
                                <td colspan="5" align="center" bgcolor="#FFFFFF"><img src="https://www.lancamentosonline.com.br/imagens/empreendimento/'.$oferta["id_empreendimento"].'/arquivo/'.$oferta["logomarca"].'" title="'.$oferta["nome_empreendimento"].'" width="125" height="95"></td>
                              </tr>
                              <tr>
                                ...
                                <td colspan="3" align="left" bgcolor="#FFFFFF" style="font:600 16px Open Sans, Arial, Helvetica, sans-serif; color:#333;">'.$oferta["nome_torre"].' - Unidade '.$oferta["nomeclatura"].'</td>
                              </tr>
                              ';
                                if($oferta["tipo_condominio"] == 'Lotes' || $oferta["id_subtipo"] == 6 || $oferta["id_subtipo"] == 10):
                                $template_email.='
                                <tr>
                                  ...
                                  <td height="20" align="left" bgcolor="#FFFFFF"><span class="smallfont" style="font:600 14px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;">Tipo da Unidade:</span></td>
                                  <td width="29%" height="20" align="left" bgcolor="#FFFFFF" style="font:600 16px Open Sans, Arial, Helvetica, sans-serif; color:#333;">'.$oferta["tipo_condominio"].'</td>
                                  ...
                                  <td width="26%" align="left" bgcolor="#FFFFFF" style="font:600 16px Open Sans, Arial, Helvetica, sans-serif; color:#333;">De'.converte_valor_real($oferta["area_unidade_min"]).' à '.converte_valor_real($oferta["area_unidade_max"]).'m²</td>
                                </tr>
                                ';
                                else:
                                $template_email.='
