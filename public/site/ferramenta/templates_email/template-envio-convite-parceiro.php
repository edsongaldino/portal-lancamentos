...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="full">
  <tr>
    <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="border-radius:5px 5px 0 0; background-color:#CB3439;">
              <tr>
                <td height="29">&nbsp;</td>
              </tr>
              <tr>
                <td><table border="0" cellspacing="0" cellpadding="0" align="left" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                  ...
                  <table width="250" border="0" cellspacing="0" cellpadding="0" align="right" class="inner" style="border-collapse:collapse; height:60px; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    ...
                    <tr>
                      <td align="center" style="background: #AE3335; color: #ffffff; font: bold 20px/50px Arial, Helvetica, sans-serif;"><a class="top-button" style="font: bold 20px/50px Arial, Helvetica, sans-serif; line-height: 60px; color: #ffffff; height: 60px !important; text-decoration: none; display: block; text-transform: uppercase;">CONVITE</a></td>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                          <tr>
                            <td style="font:bold 20px Arial, Helvetica, sans-serif; color:#777;" class="smallfont"><p>Ol&aacute;,</p>
                            <p>Voc&ecirc; foi convidado por <span style="font:bold 22px Arial, Helvetica, sans-serif; color:#444;">('.utf8_encode($nome_usuario_convite).')</span>, '.$perfil_usuario_convite.' da '.utf8_encode($nome_construtora).' a fazer parte de sua rede de parceiros e comercializar seus empreendimentos.</p></td>
                          </tr>
                          <tr>
                            <td height="20">&nbsp;</td>
                          </tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td height="16" colspan="2" align="center"><img src="'.$logo_construtora.'" width="200" ></td>
                      <td width="23" height="16">&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="16">&nbsp;</td>
                      <td width="79" align="center">&nbsp;</td>
                      <td width="475" height="16" align="center"></td>
                      <td height="16">&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="16">&nbsp;</td>
                    ...
                    <tr>
                      <td height="16">&nbsp;</td>
                      <td height="50" colspan="2" align="center" style="width:100px !important; height:50px !important; background: #AE3335; line-height:50px;"><span class="readmore-button"><a href="'.$link_redirect.'" style="font: bold 12px/40px Arial, Helvetica, sans-serif; color: #ffffff; text-decoration: none; padding:10px 50px 10px 50px; line-height:50px; text-align:center; text-transform: uppercase;">ACEITAR CONVITE</a></span></td>
                      <td height="16">&nbsp;</td>
                    </tr>
                  </table></td>
              </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="full">
  <tr>
    <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" bgcolor="#AE3335" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style=" background-image:url(http://sistema.domuslog.com.br/ferramenta/templates_email/images/white-bg.gif); background-repeat:repeat-x; background-position:left top;">
              <tr>
                <td height="23">&nbsp;</td>
              </tr>
              <tr>
              ...
              <td><table class="inner" align="left" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      <td height="18" align="center" style="font:12px Helvetica,  Arial, sans-serif; color:#AAA;"><p>'.$email_parceiro.'</p>
                        <p>&nbsp;</p></td>
                    </tr>
                  </table></td>
                  <td width="21">&nbsp;</td>
