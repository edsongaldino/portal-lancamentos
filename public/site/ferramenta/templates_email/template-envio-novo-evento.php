              ...
              <tr>
                <td><table border="0" cellspacing="0" cellpadding="0" align="left" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                  ...
                  <table width="250" border="0" cellspacing="0" cellpadding="0" align="right" class="inner" style="border-collapse:collapse; height:60px; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    ...
                    <tr>
                      <td align="center" style="background: #00B2B2; font: bold 20px/30px Arial, Helvetica, sans-serif; line-height: 60px; color: #ffffff; height: 60px !important; text-decoration: none; display: block; text-transform: uppercase;""><a class="top-button" style="font: bold 20px/30px Arial, Helvetica, sans-serif; line-height: 60px; color: #ffffff; height: 60px !important; text-decoration: none; display: block; text-transform: uppercase;">NOVO EVENTO</a></td>
    ...
    <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-color:#ffffff;">
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                          <tr>
                            <td colspan="2" class="smallfont" style="font:bold 20px Arial, Helvetica, sans-serif; color:#008A8A;"><p>Ol&aacute; '.$notificacao["nome_destinatario"].', </p>
                            <p>Um novo evento foi publicado no Domus pela construtora '.$notificacao["nome_abreviado"].'.</p></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td height="68"><img src="http://sistema.domuslog.com.br/ferramenta/templates_email/img/icone-evento.png" width="60" height="60"></td>
                            <td style="font:bold 16px Arial, Helvetica, sans-serif; color:#008A8A;">'.$notificacao["titulo_notificacao"].'</td>
                          </tr>
                          <tr>
                            <td height="75"><img src="http://sistema.domuslog.com.br/ferramenta/templates_email/img/icone-data.png" width="60" height="60"></td>
                            <td style="font:bold 20px Arial, Helvetica, sans-serif; color:#F90;">'.$notificacao["data_notificacao"].' às '.$notificacao["hora_notificacao"].'h</td>
                          </tr>
                          <tr>
                            <td height="20"><img src="http://sistema.domuslog.com.br/ferramenta/templates_email/img/icone-mapa.png" width="60" height="60"></td>
                            <td style="font:bold 14px Arial, Helvetica, sans-serif; color:#999;">'.$notificacao["local_notificacao"].'</td>
                          </tr>
                        </table></td>
                      <td width="23" class="sidespace">&nbsp;</td>
                    </tr>
              ...
              <tr>
                <td height="231" align="center"><img src="http://m.lancamentosonline.com.br/conteudos/construtora/construtora-'.$notificacao["id_construtora"].'.png" alt="" width="200" ></td>
              </tr>

              <tr>
                <td align="center" style="font:300 16px Open Sans, Arial, Helvetica, sans-serif; color:#999;" class="smallfont">'.$endereco_construtora.'</td>
              </tr>
              <tr>
                <td height="19" align="center"><span class="smallfont" style="font:300 16px Open Sans, Arial, Helvetica, sans-serif; color:#666;; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 16px">(65) 99938-8260</span></td>
              </tr>
              <tr>
                <td style="border-bottom:1px solid #dbdbdb;">&nbsp;</td>
              </tr>
              <tr>
              <td height="50" colspan="2" align="center" style="width:100px !important; height:50px !important; background: #16c4a9; line-height:50px; font: bold 12px/40px Arial, Helvetica, sans-serif; color: #ffffff; text-decoration: none; padding:10px 50px 10px 50px; line-height:50px; text-align:center; text-transform: uppercase;"><span class="readmore-button"><a href="http://sistema.domuslog.com.br" style="font: bold 12px/40px Arial, Helvetica, sans-serif; color: #ffffff; text-decoration: none; padding:10px 50px 10px 50px; line-height:50px; text-align:center; text-transform: uppercase;">FAZER LOGIN E CONFIRMAR PRESENÇA</a></span></td>
            </tr>
            </table></td>
        </tr>
      </table></td>
