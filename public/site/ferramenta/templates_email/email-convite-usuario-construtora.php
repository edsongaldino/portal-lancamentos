              ...
              <tr>
                <td><table border="0" cellspacing="0" cellpadding="0" align="left" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                  ...
                  <table width="250" border="0" cellspacing="0" cellpadding="0" align="right" class="inner" style="border-collapse:collapse; height:60px; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    ...
                    <tr>
                      <td align="center" style="background: #00B2B2;"><a class="top-button" style="font: bold 20px/30px Arial, Helvetica, sans-serif; line-height: 60px; color: #ffffff; height: 60px !important; text-decoration: none; display: block; text-transform: uppercase;">CONVITE</a></td>
    ...
    <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-color:#ffffff;">
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                          <tr>
                            <td style="font:bold 20px Arial, Helvetica, sans-serif; color:#008A8A;" class="smallfont"><p>Ol&aacute;, '.$nome_parceiro.'</p>
                            <p>'.$nome_usuario_convite.' da '.$origem_convite.' Convidou voc&ecirc; para acesssar os Lan&ccedil;amentos Imobili&aacute;rios no Domus</p></td>
                          </tr>
                          <tr>
                            <td height="20">&nbsp;</td>
                          </tr>
              ...
              <tr>
                <td align="center" style="font:600 27px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;" class="smallfont"><span>'.$nome_usuario_convite.'</span></td>
              </tr>
              <tr>
                <td align="center" height="20" class="smallfont" style="font:300 14px Open Sans, Arial, Helvetica, sans-serif; color:#999;"><span>'.$perfil_usuario_convite.'</span></td>
              </tr>
              <tr>
                <td height="19" align="center" class="smallfont" style="font:300 16px Open Sans, Arial, Helvetica, sans-serif; color:#666;"><span>'.$telefone_usuario_convite.'</span></td>
              </tr>
              <tr>
                <td height="19" align="center" class="smallfont" style="font:300 16px Open Sans, Arial, Helvetica, sans-serif; color:#555;"><span>'.$email_usuario_convite.'</span></td>
              </tr>
              <tr>
                <td style="border-bottom:1px solid #dbdbdb;">&nbsp;</td>
              </tr>
              ...
              <td><table class="inner" align="left" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      <td height="18" align="center" style="font:12px Helvetica,  Arial, sans-serif; color:#AAA;"><p>'.$email_usuario.'</p>
                        <p>&nbsp;</p></td>
                    </tr>
                  </table></td>
                  <td width="21">&nbsp;</td>
