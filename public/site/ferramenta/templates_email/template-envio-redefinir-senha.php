...
$template_email = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<head>
	...
	<title>Domus - A maior rede de construtoras e incorporadoras de Mato Grosso</title>
	<style type="text/css">
		/* RESET STYLES */
		...
		#emailFooter{background-color:#F8F8F8 !important;}
		...
		<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
			<tr>
				<td align="center" valign="top" id="bodyCell">
															...
															<tr>
																<td align="center" valign="top" class="textContent">
																	<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;"><div align="center">
																	  <table width="0" border="0" align="center" cellpadding="0" cellspacing="0" class="emailButton">
																	    <tr>
																	      <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;"><a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="#" target="_blank"><img src="https://www.lancamentosonline.com.br/ferramenta/templates_email/img/logo_lancamentos.png" alt="" width="200" height="99" /></a></td>
																        </tr>
																      </table>
																	</div></h1>
																	<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:16px;margin-bottom:10px;color:#333;line-height:135%; margin-top:20px;">Ol&aacute; <strong>'.$nome_usuario.'</strong>, recebemos uma solicita&ccedil;&atilde;o para redefini&ccedil;&atilde;o de senha. Caso n&atilde;o tenha solicitado, acesse sua conta e altere seus dados de acesso, do contr&aacute;rio clique no link abaixo e gere uma nova senha de acesso.</h2></td>
															</tr>
														</table>
														<!-- // CONTENT TABLE -->
																	...
																	<table border="0" cellpadding="0" cellspacing="0" width="100%">
																		<tr class="flexibleContainer">
																		  <td style="padding-top:0;" align="center" valign="top" class="flexibleContainerCell"><!-- CONTENT TABLE // -->
																		    <table border="0" cellpadding="0" cellspacing="0" width="70%" class="emailButton" style="background-color: #0059B2;">
																		      <tr>
																		        <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;"><a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:16px;line-height:135%;" href="'.$link.'" target="_blank">Redefinir senha</a></td>
																	          </tr>
																	        </table>
																		    <!-- // CONTENT TABLE --></td>
																	  </tr>
					...
					<!-- EMAIL FOOTER // -->
					<table bgcolor="#F8F8F8" border="0" cellpadding="0" cellspacing="0" width="100%" id="emailFooter">
														...
														<table border="0" cellpadding="30" cellspacing="0" width="100%">
															<tr>
																<td valign="top" bgcolor="#F8F8F8">
																	...
																	<div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
																		<div>Este e-mail foi enviado para '.$email.'</div>
																	</div>
