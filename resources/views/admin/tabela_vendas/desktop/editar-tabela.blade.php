...
<form action="{{ route('atualizar-tabela', $tabela->id) }}" id="formAtualizarTabelaVendas" name="formAtualizarTabelaVendas" method="POST">
@include('admin/tabela_vendas/desktop/form')
<button id="atualizar-tabela" class="btn btn-info gravar-tabela modal-confirm"><i class="fa fa-save"></i> Gravar Tabela de Vendas</button>
</form>
