                  ...
                  <div class="row">
                    <div class="col-sm-4 col-xs-4 selectContainer">
                      ...
                      <select class="form-control" name="tipo_ponto" id="tipo_ponto" required="required">                                                      
                        <option value="V" selected>Vaga</option>
                ...
                <div class="panel-body">
                  <div class="row">
                    ...
                    <div class="col-sm-4 col-xs-4 selectContainer" id="tamPonto">
                      ...
                      <select class="form-control" name="tam_implantacao_garagem" id="tam_implantacao_garagem" required="required">                                                      
                        <option value="pq" @php if ($empreendimento->getCaracteristica('tam_implantacao_garagem') == "pq") {echo "selected";} @endphp>Pequeno</option>
                        <option value="md" @php if ($empreendimento->getCaracteristica('tam_implantacao_garagem') == "md") {echo "selected";} @endphp>Médio</option>
                        <option value="gd" @php if ($empreendimento->getCaracteristica('tam_implantacao_garagem') == "gd") {echo "selected";} @endphp>Grande</option>
                      </select>
                    </div>

                    <div id="vinculo_garagem" class="col-sm-8 col-xs-8 selectContainer">
                      <label>Unidade</label>
                      <select class="form-control" name="garagem_id" id="ponto_garagem">
                        <option value="">&nbsp;</option>                        
                        @php
                          $garagens = $empreendimento
                            ->garagens
                      ...
                      <div id="vinculo_imagem" class="col-sm-12 col-xs-12 selectContainer">
                        ...
                        <select class="form-control" name="foto_id" id="ponto_imagem">
                          <option value="">&nbsp;</option>                                                                                  
                          @foreach ($garagem->empreendimento->fotos as $foto)
    ...
    <div class="modal fade" id="modal_excluir" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="form2">
              <input type="hidden" name="garagem_id" id="garagem_id"/>
