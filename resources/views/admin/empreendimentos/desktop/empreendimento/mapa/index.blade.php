...
<head>
  ...
  <link rel="stylesheet" href="/global/css/loader/index.css?v={{ filemtime('global/css/loader/index.css') }}">
  <link rel="stylesheet" href="/site/mapa/css/mapa2.css?v={{ filemtime('site/mapa/css/mapa2.css') }}">
  ...
  <div id="tela">
    ...
    @php
      $fotos = $empreendimento->fotos->where(['status', 'Liberada'],['tipo','<>','Implantação']);
    @endphp
  ...
  @include('admin.empreendimentos/desktop/empreendimento/mapa/unidade_mapa')
  ...
  <script src="/assets/javascripts/empreendimento/mapa.js?v={{ filemtime('assets/javascripts/empreendimento/mapa.js') }}"></script>
