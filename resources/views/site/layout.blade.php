    ...
    <header class="menu-topo">
        ...
        <div class="menu">
          @if(isset($empreendimento))
            <div class="item"><a href="/lista.html?subtipo_id={{ $empreendimento->subtipo_id }}" target="_blank"><i class="fa fa-search"></i> Ver outros anúncios</a></div>
          @else
            <div class="item"><a href="/lista.html" target="_blank"><i class="fa fa-search"></i> Ver outros anúncios</a></div>
          @endif
