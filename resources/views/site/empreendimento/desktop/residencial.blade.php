<div class="details-parameters-cont detalhe">                       
  <div class="details-parameters-icon">
    <i class="fa fa-home fa-2x" aria-hidden="true" title="Casas em Condomínio Fechado"></i>
  </div>
...
<div class="details-parameters-cont detalhe">
  <div class="details-parameters-icon"><i class="fa fa-bed fa-2x" aria-hidden="true"></i></div>
...
<div class="details-parameters-cont detalhe">
  <div class="details-parameters-icon"><i class="fa fa-car fa-2x" aria-hidden="true"></i></div>
