...
<head>
  ...
  <div id="tela">
    ...
    <img id="mapa_fundo" src="{{ $empreendimento->getFotoTipo('Implantação - Área de Lazer') }}"/>

  </div>

  @include('admin.empreendimentos/desktop/empreendimento/mapa/fotos_mapa')
  ...
  <script src="/assets/javascripts/empreendimento/mapa.js"></script>
