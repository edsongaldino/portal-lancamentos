                ...
                <tr>
                  <td><table width="97%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td width="594"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                        <tr>
                          <td align="center"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/img/icone-user.png" alt="" width="60" height="60"></td>
                        </tr>
                        <tr>
                          <td align="center" class="smallfont" style="font:600 27px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;">{{ $lead->nome }}</td>
                        </tr>
                        <tr>
                          <td height="19" align="center"><span class="smallfont" style="font:300 16px Open Sans, Arial, Helvetica, sans-serif; color:#666;; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 16px">{{ $lead->telefone ?? '' }}</span></td>
                        </tr>
                        <tr>
                          <td height="19" align="center"><span class="smallfont" style="font:300 16px Open Sans, Arial, Helvetica, sans-serif; color:#555;; font-family: Open Sans, Arial, Helvetica, sans-serif; font-size: 16px">{{ $lead->email ?? '' }}</span></td>
                        </tr>
                        <tr>
                          <td height="20">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                          <td height="68" align="center">
                            <img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/img/tipo_empreendimento_{{ $lead->empreendimento->subtipo->id }}.png" alt="" width="60" height="60"></td>
                          </tr>
                          <tr>
                  ...
                  <tr>
                    <td style="border-bottom:1px solid #dbdbdb;"><table width="100%" bgcolor="#00B2B2" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style=" background-image:url(https://sistema.domuslog.com.br/ferramenta/templates_email/images/white-bg.gif); background-repeat:repeat-x; background-position:left top;">
                      ...
                      <tr>
                        <td width="639" align="center"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/mensagem.png" width="83" height="83" alt="picture" /></td>
                      </tr>
                      <tr>
                        <td height="23">&nbsp;</td>
                      </tr>
                      <tr>
                        <td height="50" align="center" style="width:100px !important; font:18px Arial, Helvetica, sans-serif; color:#FFFFFF; height:50px !important; background: #16c4a9;  text-transform:uppercase; line-height:50px;"><span class="readmore-button">Contato - Portal</span></td>
                      </tr>
                      <tr>
                        <td height="23" style="font:18px Arial, Helvetica, sans-serif; color:#FFFFFF; text-align:center; height:50px !important; line-height:50px">
                          {{ date('d/m/Y H:i') }}
                        </td>
                      </tr>
                      <tr>
                        <td height="84" align="center" class="smallfont" style="font:16px Arial, Helvetica, sans-serif; font-style:italic; color:#FFFFFF; padding:0 15px 0 15px;"><p>{{ $lead->mensagem }}</p></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td height="16" colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#00B2B2" class="full" style=" background-image:url(https://sistema.domuslog.com.br/ferramenta/templates_email/images/white-bg.gif); background-repeat:repeat-x; background-position:left top;">
                          <tr>
                            <td height="16" colspan="3" align="center" bgcolor="#FFFFFF"><p><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/logo-qualificacao.png" width="60" height="60" /></p></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td width="124" height="16" align="center" bgcolor="#EEEEEE"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/icone_renda.png" width="50" height="50" /></td>
                            <td width="189" align="center" bgcolor="#EEEEEE" style="font:600 16px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;">Renda</td>
                            <td width="287" align="center" bgcolor="#EEEEEE" style="font:600 18px Open Sans, Arial, Helvetica, sans-serif; color:#FC0;">{{ $lead->renda ?? ''}}</td>
                          </tr>
                          <tr>
                            <td height="16" align="center" bgcolor="#FFFFFF"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/icone_chave.png" alt="" width="50" height="50" /></td>
                            ...
                            <td align="center" bgcolor="#FFFFFF" style="font:600 18px Open Sans, Arial, Helvetica, sans-serif; color:#FC0;">{{ $lead->previsao ?? ''}}</td>
                          </tr>
                          <tr>
                            <td height="16" align="center" bgcolor="#EEEEEE"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/icone_itens.png" alt="" width="50" height="50" /></td>
                            ...
                            <td align="center" bgcolor="#EEEEEE" style="font:600 18px Open Sans, Arial, Helvetica, sans-serif; color:#FC0;">{{ $lead->interesse ?? ''}}</td>
                          </tr>
                          <tr>
                            <td height="16" align="center" bgcolor="#FFFFFF"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/icone_tempo.png" alt="" width="50" height="50" /></td>
                            <td align="center" bgcolor="#FFFFFF" style="font:600 16px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;">Tempo no site</td>
                            <td align="center" bgcolor="#FFFFFF" style="font:600 18px Open Sans, Arial, Helvetica, sans-serif; color:#FC0;">{{ $lead->tempo }}</td>
                          </tr>
                          <tr>
                            <td height="16" align="center" bgcolor="#EEEEEE"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/icone_origem.png" alt="" width="50" height="50" /></td>
                            <td align="center" bgcolor="#EEEEEE" style="font:600 16px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;">Origem</td>
                            <td align="center" bgcolor="#EEEEEE" style="font:600 18px Open Sans, Arial, Helvetica, sans-serif; color:#FC0;">{{ $lead->origem }}</td>
                          </tr>
                          <tr>
                            <td height="16" align="center" bgcolor="#FFFFFF"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/icone_dispositivo.png" alt="" width="50" height="50" /></td>
                            <td align="center" bgcolor="#FFFFFF" style="font:600 16px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;">Dispositivo</td>
                            <td align="center" bgcolor="#FFFFFF" style="font:600 18px Open Sans, Arial, Helvetica, sans-serif; color:#FC0;">{{ $lead->dispositivo }}</td>
                          </tr>
                          <tr>
                            <td height="16" colspan="3" bgcolor="#FFFFFF"></td>
                          </tr>
                    ...
                    <td height="16" bgcolor="#FFFFFF"><table width="639" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
                      <tr>
                        ...
                        <tr style="background-color: #FFFFFF;">
                          <td height="20" align="center" style="background-color: #FFFFFF;"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/img/icone-desktop.png" alt="" width="50" height="50" /></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr>
